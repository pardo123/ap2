...
public class Curp {
	...
	private String nombre; //a qui se declara varios parametros de tipo String
	private String paterno;
	private String materno;
	private String sexo;
	private String estado;
	private int dd; //en esta parte se declara un parametro de tipo entero qu sera provadp
	private int mm;
	private int yyyy;
	
	/*Arreglo de tipo String que contiene las
	 * calves de las entidades federativas de M�xico*/
